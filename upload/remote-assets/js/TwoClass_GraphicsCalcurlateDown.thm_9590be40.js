	...
	function TwoClass_GraphicsCalcurlateDown_Page11Scene_Skin() {
		_super.call(this);
		this.skinParts = ["img_bg","img0","img1","img2","img3","img4","img5","img6","img7","img8","img9","rect0","t1","group"];
	...
	_proto.group_i = function () {
		var t = new eui.Group();
		this.group = t;
		t.elementsContent = [this.img_bg_i(),this.img0_i(),this.img1_i(),this.img2_i(),this.img3_i(),this.img4_i(),this.img5_i(),this.img6_i(),this.img7_i(),this.img8_i(),this.img9_i(),this.rect0_i(),this.t1_i()];
		return t;
	};
	_proto.img_bg_i = function () {
		var t = new eui.Image();
	...
	_proto.t1_i = function () {
		var t = new eui.Image();
		this.t1 = t;
		t.source = "TwoClass_GraphicsCalcurlateDown_big_page_scene11_json.TwoClass_GraphicsCalcurlateDown_11_1";
		t.x = 402.02;
		t.y = 274.74;
		return t;
	};
